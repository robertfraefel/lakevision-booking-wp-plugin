...
<div class="wrap lvb-wrap">
    ...
    <form method="post">
        ...
        <div class="lvb-settings-section">
            <h2>Intake Form</h2>
            <p class="description">
                Optionales Anmeldeformular für Neukunden. Wenn deaktiviert, sind die Menüpunkte
                <em>Intake Forms</em> und <em>Intake Form Builder</em> in der Seitenleiste
                ausgeblendet und der Shortcode auf der Website zeigt einen Hinweis, dass das
                Formular aktuell nicht verfügbar ist.
            </p>
            <table class="form-table">
                <tr>
